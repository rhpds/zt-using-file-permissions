...
From the *>_ root* terminal confirm that *root* is the initial owner of the file
*tasks.txt*:
...
.thirdfourth
image::thirdandfourthcolumn-zt-root.png[thirdfourth]
